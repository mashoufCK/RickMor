...
protocol RMLocationDetailViewDelegate: AnyObject {
    func rmEpisodeDetailView(
        _ detail: RMLocationDetailView, didSelect character: RMCharacter)
...
extension RMLocationDetailView: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        case .information(let viewModels):
            let cellViewMdodels = viewModels[indexPath.row]
            ...
            cell.configure(with: cellViewMdodels)
...
extension RMLocationDetailView {
    ...
    func createCharacterLayout() -> NSCollectionLayoutSection {
        ...
        let group = NSCollectionLayoutGroup.horizontal(layoutSize: NSCollectionLayoutSize(widthDimension: .fractionalWidth(1.0), heightDimension: .absolute(270)), subitems: [item, item])
